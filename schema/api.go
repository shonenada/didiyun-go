...
const LIST_VPC_URL = API_BASE + "/network/vpc/count"
const CREATE_VPC_URL = API_BASE + "/network/vpc/assign"
const CREATE_VPC_URL = API_BASE + "/network/vpc/delete"
...
const ATTACH_NAME_SG_URL = API_BASE + "/network/sg/attach"
const DETACH_NAME_SG_URL = API_BASE + "/network/sg/detach"
const LIST_SG_RULE_URL = API_BASE + "/network/sg/rule/list"
const CREATE_SG_RULE_URL = API_BASE + "/network/sg/rule/create"
